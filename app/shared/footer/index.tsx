...
const Footer: FunctionComponent = () => {
  return (
    <>
      <Divider />
      <Box component="footer" padding={8}>
        <Typography
          component="h6"
          level="h4"
          marginBottom={4}
        ...
        >
          <Box sx={{ flex: "1 1" }}>
            ...
            >
              ...
              des propriétaires qui souhaitent mettre à disposition un logement
              pour une courte ou moyenne durée et des locataires à la recherche
              d'une location ou d'une sous-location temporaire. L'objectif est
              de favoriser la mobilité et de permettre à chacun de réaliser ses
          ...
          >
            <Box marginBottom={4}>
              ...
              <List size="sm" aria-labelledby="decorated-list-demo">
                <ListItem
                  sx={{ padding: 0, color: "#ffffff", fontWeight: 300 }}
                >
