  ...
  return (
    ...
    >
      ...
      <Typography marginTop={2}>
        Les données personnelles sont notamment protégées par la loi n° 78-87 du
        6 janvier 1978, la loi n° 2004-801 du 6 août 2004, l’article L. 226-13
      ...
      <Typography marginTop={2}>
        Les données et fichiers sont enregistrés dans une base de données et un
        espace de stockage mise à disposition par l'entreprise Supabase. Les
      ...
      <Typography marginTop={2}>
        ...
        fournis par un fournisseur d’outil analytique de tierce partie, mais ne
        sont utilisés qu’à des fins liées au site lacartedeslogements.com.
      </Typography>
      ...
      <Typography marginTop={2}>
        ...
        d’informer de la présence de cookies et éventuellement de les supprimer
